...
## 謝辞
このアプリ [daig0rian/epcltvapp](https://github.com/daig0rian/epcltvapp) は私が望んでいた機能を持っているアプリでした。とても感謝しております。ありがとうございます。
感謝の意味を込めてライブ視聴機能を追加してみました。
...
- USBデバッグが使えない環境でもクラッシュ内容を確認できるログ機能(次回起動時にExceptionをダイアログで表示する)


## ライブ視聴の EPGStation config.yml 設定について
